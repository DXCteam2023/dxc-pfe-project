...
function ContactPage() {
  ...
  function sendEmail(e : any){
        e.preventDefault();
        emailjs.sendForm('service_6e9p4ki','template_szd1t2g', e.target,
        "hnGgBAvE8gHtmAvZw"
       ).then(res=>{
         console.log(res);
      ...
      <div className="flex justify-around items-center mx-20 md:flex-row flex-col">
        ...
        <div className="md:w-1/2 w-full md:p-10 my-10 md:my-0  flex-col">
          ...
          <div className="flex-col my-20 gap-5 flex  ">
            <div className="flex gap-5 p-4 border border-gray-500 hover:border-blue-700 md:w-1/2 w-full rounded-lg group cursor-pointer items-center">
              ...
              <a href="tel:+21252234434554"> <p className="text-gray-500 text-base font-semibold group-hover:text-white">
                +212 52234434554
              </p></a>
            ...
            <div className="flex gap-5 p-4 border border-gray-500 hover:border-blue-700 md:w-1/2 w-full rounded-lg group cursor-pointer items-center">
              ...
              <a href="mailto:iwa.dxc@gmail.com"><p className="text-gray-500 text-base font-semibold group-hover:text-white">
                dxc@gmail.com
              </p></a>
            </div>
            <div className="flex gap-5 p-4 border border-gray-500 hover:border-blue-700 md:w-1/2 w-full rounded-lg group cursor-pointer items-center">
        ...
        <form onSubmit={sendEmail}>
            ...
            <div className="flex justify-center">
              <textarea name="message" className="form-control block w-full px-3 py-2 mb-5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-md transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
      ...
      <div className="mx-auto max-w-2xl lg:max-w-4xl">
        <figure className="mt-10" style={{ marginTop:"-5px" }}>
          <blockquote className="text-center text-xl font-semibold leading-8 text-gray-900 sm:text-3xl sm:leading-9" >
            <p>
            DXC Technology recognized by Gartner® as a Leader in the 2023 Magic Quadrant™ for Outsourced Digital Workplace Services
            </p>
        ...
        <div id="google-maps-canvas" style={{ height: "100%", width: "100%", display: "flex", justifyContent: "center", alignItems: "center", marginTop:"50px" }}><iframe style={{ height:"450px", width:"90%", border:"0" }} src="https://www.google.com/maps/embed/v1/place?q=Casablanca+Nearshore,+Boulevard+El+Qodsboulevard+El+Qods،+Casablanca+11000&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"></iframe></div>
