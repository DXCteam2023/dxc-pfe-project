...
export default function AllProductSpecificationsPage() {
  ...
  useEffect(() => {
    getProductSpecifications(setProductSpecfications);
  }, []);
                  ...
                  <div className="my-2 flex sm:flex-row flex-col">
                    <div className="flex flex-row mb-1 sm:mb-0">
                      <div className="relative ">
                        <select className=" ml-2 px-3 py-2 border border-gray-300 focus:outline-none rounded-lg shadow-sm">
                    ...
                    <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
                      ...
                      <div className="px-5 py-5 bg-white border-t flex flex-col xs:flex-row items-center xs:justify-between          ">
                        ...
                        <div className="inline-flex mt-2 xs:mt-0">
                          <button className="text-sm bg-wpurple-700 hover:bg-purple-400 text-white fo font-semibold py-2 px-4 rounded-l">
                            Previous
                          </button>

                          <button className="text-sm bg-purple-700 hover:bg-purple-400 text-white font-semibold py-2 px-4 rounded-r">
                            Next
                          </button>
                        </div>
                      </div>
