...
import { ShoppingBagIcon, ShoppingCartIcon , BuildingStorefrontIcon} from "@heroicons/react/24/solid";
const Header = () => {
  return (
    
    <header className="h-14 bg-gradient-to-r from-violet-500 to-fuchsia-500 from-sky-200 to-sky-50 border shadow p-2 flex">
