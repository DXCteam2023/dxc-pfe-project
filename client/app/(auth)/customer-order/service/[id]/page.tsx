                  ...
                  <div className="flex-1 bg-white rounded-lg shadow-xl p-8">
                    ...
                    <ul className="mt-2 text-gray-700">
                      ...
                      <li className="flex border-b py-2">
                        ...
                        <span className="text-gray-700">
                          {" "}
                          {new Date(service.requestedStartDate).toDateString()}
                        </span>
                      </li>
                      <li className="flex border-b py-2">
                        ...
                        <span className="text-gray-700">
                          {" "}
                          {new Date(service.requestedCompletionDate).toDateString()}
                        </span>
                      </li>
                      <li className="flex border-b py-2">
                        <span className="font-bold w-24">
                      ...
                      <li className="flex border-b py-2">
                        ...
                        <span className="text-gray-700">
                          {" "}
                          {new Date(service.expectedCompletionDate).toDateString()}
                        </span>
                      </li>
                      <li className="flex border-b py-2">
                ...
                <div className="flex flex-col w-full 2xl:w-2/3">
                  <div className="flex-1 bg-white rounded-lg shadow-xl mt-4 p-8">
                    <div className="relative ">
                      <div className="absolute h-full border border-dashed border-opacity-20 border-secondary"></div>
                      <div className="bg-white p-3 hover:shadow">
                        <span className="flex items-center font-semibold text-gray-900 text-xl leading-8">Orders Per Week</span>
                        <Chartt />
                        <div className="flex items-center font-semibold text-gray-900 text-xl leading-8">
                          <span className="text-purple-500"></span>
