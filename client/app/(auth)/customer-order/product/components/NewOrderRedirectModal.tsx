                        ...
                        <div className="sm:flex sm:items-start">
                            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                                ...
                                <div className="mt-2 flex w-full h-40 gap-2" >
                                    <div onClick={handleProductOrderOnClick} className={`flex flex-col items-center border-2 p-2 w-full justify-center rounded-lg ${selected == PRODUCT_ORDER ? "border-[#5f249ff0]" : ""}`} >
                                        <GiRadioTower />
                                        Product Order
                                    </div>

                                    <div onClick={handleServiceOrderOnClick} className={`flex flex-col items-center border-2 p-2 w-full justify-center rounded-lg ${selected == SERVICE_ORDER ? "border-[#5f249ff0]" : ""}`} >
                                        <AiOutlineGlobal />
                                        Service  Order
                                    </div>
