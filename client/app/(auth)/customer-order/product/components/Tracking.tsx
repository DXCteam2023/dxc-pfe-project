...
import { FaCheckCircle, FaTimesCircle, FaArrowRight, FaCheck, FaTimes } from 'react-icons/fa';
...
const Tracking = () => {
  ...
  return (
    ...
    <p>Fulfillment (In Progress) : if at least one of OLI state is completed</p>
    <p>Customer Order (Completed) ; if state is completed</p>
    <p>Cancellation request (Assessing cancellation) if state assessing_cancellation  cancellation_received  canceled</p>
    <p>Cancellation approved (Cancellation in progress) if state cancellation_received || canceled</p>
