...
const Header = () => {
  ...
  const handleSearchClick = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    setPopupOpen(true);
    console.log(dataProductOfferings);
    ...
    <div className="flex justify-between items-center px-4 py-4 bg-white relative">
      ...
      <div className="w-5/6">
        <form onSubmit={handleSearchClick}>
          <ReactModal isOpen={isPopupOpen} onRequestClose={handlePopupClose}>
            {" "}
                    ...
                    <div className="md:flex items-center -mx-10">
                      ...
                      <div className="w-full md:w-1/2 px-10">
                        <div className="mb-10">
                          ...
                          <p className="text-sm">
                            Contract Terms :{result.Contract_terms}
                          </p>
                        ...
                        <div>
                          ...
                          <div className="inline-block align-bottom">
                            <button className="bg-yellow-300 opacity-75 hover:opacity-100 text-yellow-900 hover:text-gray-900 rounded-full px-10 py-2 font-semibold">
                              <i className="mdi mdi-cart -ml-2 mr-2"></i> VIEW
                              DETAILS
                            </button>
                          </div>
                        </div>
