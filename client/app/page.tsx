                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:pt-64 lg:pb-24">
                    <div className="text-center">
                        ...
                        <p className="mt-6 text-lg leading-8 text-gray-600 font-medium">
                            Unlock the power of technology with DXC Technology |
                            MOROCCO the leading provider of comprehensive IT
                            solutions for businesses of all sizes. With a
                            passion for innovation and a commitment to
                            excellence, we empower organizations to thrive in
                            the digital age.
                        </p>
                    </div>
                </div>
            ...
            md:space-y-5"
                  ...
                  0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"
                                ...
                                <div className="text-4xl font-bold leading-none lg:text-5xl xl:text-6xl">
                                    Tailored IT Solutions to Propel Your
                                    Business Forward
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-12 sm:px-5 gap-x-8 gap-y-16">
                        <div className="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
                            ...
                            <p className="text-sm text-black">
                                We provide end-to-end management of your IT
                                infrastructure, including network design and
                                implementation, server administration, data
                                storage solutions, and proactive maintenance
                            </p>
                        </div>
                        <div className="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
                            <Image
                            ...
                            <p className="text-sm text-black">
                                Harness the power of the cloud with our
                                comprehensive range of cloud services, including
                                cloud migration, infrastructure as a service
                                (IaaS), software as a service (SaaS), and cloud
                                security solutions.
                            </p>
                        </div>
                        <div className="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
                            ...
                            <p className="text-sm text-black">
                                ...
                                with our robust cybersecurity solutions. We
                                offer proactive threat detection, vulnerability
                                assessments, firewall management, data
                                encryption, and employee training to ensure your
                                business remains secure against evolving cyber
                                threats.
                            </p>
                        </div>
                    </div>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:mx-0">
                        ...
                        <p className="mt-6 text-lg leading-8 text-gray-300">
                            Work with us and join our dynamic IT enterprise,
                            where innovation, collaboration, and endless
                            opportunities await.
                        </p>
                    </div>
