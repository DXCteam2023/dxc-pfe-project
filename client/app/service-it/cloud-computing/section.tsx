    ...
    <div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">Cloud Computing</h2>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 ">
        <dl className="grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-3 ">
          {statistic.map((statistic) => (
            <div key={statistic.id} className="mx-auto flex max-w-xs flex-col gap-y-4">
              <dt className="text-base leading-7 text-gray-600 ">{statistic.name}</dt>
    ...
    <div className="bg-white py-24 sm:py-14">
      ...
      <div className="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
            we understand the crucial role cloud computing plays in enabling organizations to achieve digital transformation and stay competitive in today's fast-paced technological landscape.
            </p>
        ...
        <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
          ...
          <div className="p-8 sm:p-10 lg:flex-auto">
            <h3 className="text-2xl font-bold tracking-tight text-gray-900">Our cloud computing service offers</h3>
            <p className="mt-6 text-base leading-7 text-gray-600">
            a comprehensive suite of features and benefits designed to meet the diverse needs of businesses across various industries,Here are some key highlights of our service:
          ...
          <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
            <div className="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
              <div className="mx-auto max-w-xs px-8">
                <p className="text-base font-semibold purple-header-links">DXC Technology | Morocco</p>
                <p className="mt-6 flex items-baseline justify-center gap-x-2">
                  <span className="text-5xl  tracking-tight text-gray-900">DXC Technology helps global companies run their mission critical systems and operations while modernising IT, optimizing data architectures, and ensuring security and scalability across public, private and hybrid clouds.</span>
