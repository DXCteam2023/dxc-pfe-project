...
const Footer = () => {
    return (
       ...
       <li>
          ...
          <li><h3 className="font-semibold purple-header-links">SERVICE IT</h3>
            <ul>
              <li> <Link
                            href="/development"
                            className="text-sm leading-6 "
          ...
          <li><h3 className="font-semibold purple-header-links">INDUSTRIE IT</h3>
          <ul>
              <li><Link
                            href="/integration"
                            className="text-sm  leading-6 "
            ...
            <p className={styles.footerCopy}>
                COPYRIGHT © 2023 DXC TECHNOLOGY MAROC . ALL RIGHTS RESERVED.<br/>
